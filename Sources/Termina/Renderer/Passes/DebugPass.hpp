...
namespace Termina {
    ...
    public:
        ...
        static void DrawSphere(const glm::vec3& center, float radius, int32 segments = 8, const glm::vec4& color = glm::vec4(1.0f), const glm::mat4* transform = nullptr);
        static void DrawCapsule(const glm::vec3& from, const glm::vec3& to, float radius, int32 segments = 4, const glm::vec4& color = glm::vec4(1.0f), const glm::mat4* transform = nullptr);
        static void DrawCone(const glm::vec3& apex, const glm::vec3& base, float radius, int32 segments = 8, const glm::vec4& color = glm::vec4(1.0f), const glm::mat4* transform = nullptr);
        ...
        static void DrawRing(const glm::vec3& center, const glm::vec3& normal, float radius, int32 segments = 16, const glm::vec4& color = glm::vec4(1.0f), const glm::mat4* transform = nullptr);
        static void DrawCylinder(const glm::vec3& from, const glm::vec3& to, float radius, int32 segments = 8, const glm::vec4& color = glm::vec4(1.0f), const glm::mat4* transform = nullptr);
